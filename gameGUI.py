...
class Game_Screen(Frame):
    ...
    def create_widgets(self):
        ...
        Label(text = "\n", bg = bg_color).grid(row = 7)
        Button(self, text = "UP", font = "Helvetica 10 bold", fg = "black", bg = "Hot Pink", command = self.up
        ).grid(row = 8, column = 0, sticky = E, columnspan = 4)
        Button(self, text = "DOWN", font = "Helvetica 10 bold", fg = "black", bg = "Hot Pink", command = self.down
        ).grid(row = 8, column = 2, sticky = W, columnspan = 4)
        Button(self, text = "LEFT", font = "Helvetica 10 bold", fg = "black", bg = "Hot Pink", command = self.left
        ).grid(row = 9, column = 0, sticky = E, columnspan = 4)
        Button(self, text = "RIGHT", font = "Helvetica 10 bold", fg = "black", bg = "Hot Pink", command = self.right
